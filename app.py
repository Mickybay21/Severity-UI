...
# @app.route('/predict')
def predict_severity(est_qty_released, process_type, incident_year, equival_hole_dia, duration_leak):
    ...
    if None in ([est_qty_released, process_type, incident_year, equival_hole_dia, duration_leak]):
...
def main():
    ...
    process_type = st.selectbox("process_type",options)
    ...
    if st.button("Predict"):
        result=predict_severity(est_qty_released, process_type, incident_year, equival_hole_dia, duration_leak)
